...
class CarData
{
    ...
    protected static $brandsWithModels = array(
        ...
        'Honda' => array(
            'Accord', 'Aerodeck', 'Brio', 'Ballade', 'Civic', 'Concerto', 'CR-V', 'CRX', 'HR-V', 'Insight', 'Integra', 'Jazz', 'Legend', 'Logo', 'NSX', 'Prelude', 'Quintet', 'S2000', 'Shuttle', 'Stream', 'Avancier', 'Capa', 'City', 'Domani', 'Element', 'F-mx', 'FIT', 'Fit Aria', 'FR-V', 'Inspire', 'Lagreat', 'Life', 'Mobilio', 'Odyssey', 'Orthia', 'Partner', 'Passport', 'Pilot', 'Saber', 'Sm-X', 'Stepwgn', 'That S', 'Torneo', 'Vamos', 'Vigor', 'Ridgeline', 'Accord Tourer', 'Crosstour', 'CR-Z', 'VLX', 'Acty', 'Rafaga', 'Beat', 'Eve', 'Elysion', 'Freed', 'BR-V'
        ),
        'Huabei' => array(
            'HC', 'HG', 'Poni'
        ),
        ...
        'Isuzu' => array(
            'Piazza', 'Trooper', 'Ascender', 'Aska', 'Axiom', 'Campo', 'Gemini', 'Impulse', 'Midi пасс.', 'Rodeo', 'VehiCross', 'Bighorn', 'Fargo', 'D-Max', 'Amigo', 'Midi груз.', 'Florian', 'TFR', 'MD', 'FRR', 'Faster', 'Hombre', 'Pick Up', 'Stylus', 'Panther', 'MU-X'
        ),
        'ItalCar' => array(
            'Attiva'
        ),
        ...
        'Porsche' => array(
            '911', '924', '928', '944', '968', 'Boxster', 'Cayenne', '959', 'Cayman', 'Panamera', '356', '997', '550', '964', 'Macan', '996', '918 Spyder', 'Taycan'
        ),
        'Praga Baby' => array(
            'Tudor', 'Baby'
        ),
        ...
        'Wuling' => array(
            'Sunshine', 'Xingwang', 'LZW', 'Confero', 'Cortez', 'Almaz', 'Formo',
        ),
        'Xiaolong' => array(
            'XLW'
        ),
